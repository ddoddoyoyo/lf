<?php
	...
	if($_SESSION["HY_LMS_SEQ"] > 0 ){
		$tools->JavaGo("/lf/sg/en/main.php");
	}
					...
					if(input.files && input.files[0]) {
						...
						reader.onload = function(e){//파일 읽어들이기를 성공했을때 호출되는 이벤트 핸들러
							...
							img.onload = function(){
								...
								imgH = img.height;
								if(imgH >= imgW){
									$("#current-img").css({"width":"99%","height":"auto"});
								}
								else{
									$("#current-img").css({"width":"auto", "height":"99%"});
								}
							}//img.onload
						}//reader.onload
					}//if
	...
	<body>
		<div id="wrap">
			<div id="contBox" class="container">
				...
				<input type="hidden" name="RETURN" value="../sg/en/main.php"/>
