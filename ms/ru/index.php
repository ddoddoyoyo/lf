<?php
	...
	if($_SESSION["HY_LMS_SEQ"] > 0 ){
		$tools->JavaGo("/lf/ms/ru/main2.php");
	}
...
<html>
	<head>
		...
		<style type="text/css">
		#page1 .textwrap p{font-size: 19px}
		</style>
	...
	<body>
		<div id="wrap">
			<div id="contBox" class="container">
				...
				<input type="hidden" name="RETURN" value="../ms/ru/main2.php"/>
				...
				<section data-role="page" id="intro" class="container">
					...
					<a href="#page0" id="btn_start">СТАРТ</a><!--data-transition="none"-->
				</section>
				<section data-role="page" id="page0" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							<h2>Здравствуйте</h2>
							<p>Укажите, пожалуйста, информацию о себе</p>
							<div class="selectbox">
				...
				<section data-role="page" id="page1" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							<h2>Здравствуйте</h2>
							<p>Добавьте, пожалуйста, вашу фотографию (по желанию)</p>
							<div class="inputbox">
								<!-- <a href="javascript:;"> -->
