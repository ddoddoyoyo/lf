var language = {
	...
	'popup' : [
		...
		[//DRM
			{
				'desc' : '<p>The Driving Rear view Monitoring (DRM) is especially useful when the view through the rear view mirror is blocked by passengers or other objects.</p><img src="../images/testdrive/002_04_02_01.png" alt="7 DCT" />'
			}
		],
		[//ASCC
			{
				'desc' : '<p>The radar at the front bumper measures and maintains the distance from the car in front at a certain level. If the car in front stops, yours will also apply the brakes accordingly. If the car in front starts within 3 seconds, yours will also do so automatically.</p><img src="../images/testdrive/002_04_03_01.png" alt="Drive Mode" />'
			},
			{
				'desc' : '<p>You can activate the function by pressing the Cruise button on the right side of the steering wheel. You can set the speed by using the lever under the button.</p><img src="../images/testdrive/002_04_03_02.png" alt="Drive Mode" />'
			}
		],
		[//BSD
			{
				'desc' : '<p>When a car approaching a blind spot is detected the BSD turns on the LED lamp on the side view mirror, warning that the driver should not change lanes. This is a safety function for preventing blind spot accidents.</p><img src="../images/testdrive/002_04_04_01.png" alt="CORNERING PERFORMANCE">'
			}
		],
		[//AEB
			{
				'desc' : '<p>The AEB (Autonomous Emergency Braking) function detects a car or a pedestrian in front with a radar and a camera. If a collision is expected, it will generate a warning first and then apply the brakes automatically if the driver doesn’t react.</p><img src="../images/testdrive/002_04_05_01.png">'
			}
		],
		[//LKAS
			{
		...
		[//AVM
			...
			{
				'desc' : '<p>In addition, the rear camera display also provides guide lines that move based on the steering wheel position making the reverse parking easier.</p><img src="../images/testdrive/002_04_10_03.png">'
			},
			{
